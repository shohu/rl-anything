...
- [GitHub Issue #15](https://github.com/min-sys/rl-anything/issues/15) — 原本（コメントで詳細）
- [Issue #14](https://github.com/min-sys/rl-anything/issues/14) — Skill 特化の PJ 固有評価（Phase 3 相当、保留中）
