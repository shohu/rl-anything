...
**できていないこと**: Skill 以外のパッチ自動生成（Compile）、自動トリガー
...
**今すぐ始められること**: Gap 2 Phase 3（all-layer-compile）— 全レイヤー診断結果からパッチを自動生成。または Gap 1 Phase 2（env-constitutional-eval）— 原則ベースの自動評価（LLM コスト発生）。
